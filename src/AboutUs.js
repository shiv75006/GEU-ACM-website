...
const AboutUs = () => {
  return (
    <div>
        <Navbar></Navbar>
        <div>
          <h1 className="Acmhead">Association for Computing Machinery(ACM)</h1>
          <div className="aboutACM">
            <p className="aboutACMparagraph">
          ...
          <div className="GEUACMdiv">
            <p className="aboutgeuacm">
          ...
          <div className="geuacmlogodiv">
            <img className="geuacmlogo"src={logo}></img>
          </div>
        </div>
        <div className="graphiceradiv">
          <h1>Graphic Era University</h1>
          <p className="graphicerapara">Graphic Era (Deemed to be University) was in existence as Graphic Era Institute of Technology since 1997,
...
<br></br>
        ...
        <div className="geulogodiv">
          <img className="geulogo"src={geulogo}></img>
        </div>


        <div>
        <div className="contdiv">
            <img src={acmlogobl}className="Acmlogocont"></img>
        </div>
        ...
        <img src={geulogocont}className="geulogocont"></img>
        ...
        <footer className="aboutuspagefooter">
        <Footer></Footer>
        </footer>
    </div>
  )
